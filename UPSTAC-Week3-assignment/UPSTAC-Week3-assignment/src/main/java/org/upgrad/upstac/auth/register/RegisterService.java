...
public class RegisterService {
    ...
    public User addUser(@RequestBody  RegisterRequest user) {
    ...
    public User addDoctor(@RequestBody  RegisterRequest user) {
    ...
    public User addGovernmentAuthority(@RequestBody  RegisterRequest user) {
    ...
    public User addTester(@RequestBody RegisterRequest user) {
